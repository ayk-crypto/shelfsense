  ...
  return (
    <div className="reports-page">
      ...
      <div className="rpt-metrics">
        <div className="rpt-metric rpt-metric--indigo">
          ...
          <div className="rpt-metric-body">
            <span className="rpt-metric-label">Total Items</span>
            <strong className="rpt-metric-value">{filteredStockSummary.length}</strong>
          </div>
        </div>
        ...
        <div className="rpt-metric rpt-metric--amber">
          ...
          <div className="rpt-metric-body">
            ...
            <strong className="rpt-metric-value">{filteredLowStock.length}</strong>
          </div>
        </div>
        ...
        <div className="rpt-metric rpt-metric--red">
          ...
          <div className="rpt-metric-body">
            <span className="rpt-metric-label">Expiry Alerts</span>
            <strong className="rpt-metric-value">{filteredExpiry.length}</strong>
          </div>
        </div>
        ...
        <div className="rpt-metric rpt-metric--green">
          ...
          <div className="rpt-metric-body">
            <span className="rpt-metric-label">Stock In</span>
            <strong className="rpt-metric-value">{filteredStockIn.length}</strong>
          </div>
        </div>
        ...
        <div className="rpt-metric rpt-metric--slate">
          ...
          <div className="rpt-metric-body">
            <span className="rpt-metric-label">Stock Out</span>
            <strong className="rpt-metric-value">{filteredStockOut.length}</strong>
          </div>
        </div>
        ...
        <div className="rpt-metric rpt-metric--orange">
          ...
          <div className="rpt-metric-body">
            <span className="rpt-metric-label">Wastage</span>
            <strong className="rpt-metric-value">{filteredWastage.length}</strong>
          </div>
        </div>
      </div>
