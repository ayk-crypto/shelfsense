...
const DEFAULT_PLANS = [
  ...
  { name: "Business", code: "BUSINESS", description: "Enterprise-grade inventory management with dedicated support and custom onboarding.", monthlyPrice: 0, annualPrice: 0, trialDays: 14, maxUsers: null, maxLocations: null, maxItems: null, maxSuppliers: null, enableExpiryTracking: true, enableBarcodeScanning: true, enableReports: true, enableAdvancedReports: true, enablePurchases: true, enableSuppliers: true, enableTeamManagement: true, enableCustomRoles: true, enableEmailAlerts: true, enableDailyOps: true, priceDisplayMode: "CUSTOM" as const, isPublic: true, sortOrder: 3 },
  { name: "Custom", code: "CUSTOM", description: "Tailored plan with custom pricing and limits.", monthlyPrice: 0, annualPrice: 0, trialDays: 0, maxUsers: null, maxLocations: null, maxItems: null, maxSuppliers: null, enableExpiryTracking: true, enableBarcodeScanning: true, enableReports: true, enableAdvancedReports: true, enablePurchases: true, enableSuppliers: true, enableTeamManagement: true, enableCustomRoles: true, enableEmailAlerts: true, enableDailyOps: true, priceDisplayMode: "CUSTOM" as const, isPublic: false, sortOrder: 4 },
] as const;
